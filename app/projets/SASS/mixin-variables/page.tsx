...
import "/styles/items/SASS/mixin-variables/style.css";

const CarComponent: React.FC = () => {
  return (
    <div className="page-wrapper">
      <div className="all-container">
        <div className="all-container__left box">
          ...
          <p className="all-container__left__text text">
            Choose sophistication. This sedan redefines elegance while
            delivering unmatched performance and refinement.
          </p>
          <button className="all-container__left__button--left button">
            Learn more
          </button>
        </div>

        <div className="all-container__middle box">
          <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              <path
          ...
          <p className="all-container__middle__text text">
            Choose dominance. This SUV combines luxury and power for those who
            demand excellence on every terrain.
          </p>
          <button className="all-container__middle__button--middle button">
            Learn more
          </button>
        </div>

        <div className="all-container__right box">
          <svg width="64" height="40" xmlns="http://www.w3.org/2000/svg">
            <g fill="none" fillRule="evenodd">
              <circle fill="#000" opacity=".201" cx="20" cy="20" r="20" />
              <path
          ...
          <p className="all-container__right_text text">
            Choose a luxury. Those cars are for the most beautiful and extremely
            performant.
          </p>
          <button className="all-container__right__button--right button">
            Learn more
          </button>
        </div>
      </div>
